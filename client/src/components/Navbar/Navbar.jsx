...
const Navbar = () => {
    ...
    const handlechat = () => {
      dispatch({ type: 'LOGOUT'});
      window.location.href='https://chatbot-frontend-topaz.vercel.app/login'
      dispatch(setCurrentUser(null))
    }
    const handleplan = () => {
      dispatch({ type: 'LOGOUT'});
      window.location.href='https://card-five-eosin.vercel.app'
      dispatch(setCurrentUser(null))
    }
  ...
  return (
    <nav className='main-nav'>
        <div className='navbar'>
            ...
            <Link to='/' className='nav-item nav-btn'  onClick={handlechat}>Chatbot</Link>
